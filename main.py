...
student1.courses_attached.append('Java')
student1.courses_attached.append('Python')
student1.grades.setdefault('Java', [9,7,8,7,10,10,8,7])

student2.grades = {'Java': [7,7,7,10,10,8,8,9]}
student2.courses_attached.append('Java')
student2.grades.setdefault('Java Core', [10,10,10,10,10,10,10,10])

print(student1)
print(student2)

print(f'Средняя оценка студента по курсу "Java": {student2.average_for_group([student1, student2], 'Java')}')

print(f'Средняя оценка лектора по курсу "Python": {lecturer1.average_for_group([lecturer1, lecturer2], 'Python')}')
